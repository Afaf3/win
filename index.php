...
<body>
     ...
     <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        ...
        <h1 class="display-4 fw-normal">اربح مع عفاف </h1>
        <p class="lead fw-normal">باقي على فتح التسجيل</p>
        <div id="demo"><div id="demo"> </div> </div>
        <p class="lead fw-normal">للسحب على سحب نسحة مجانية من البرنامج</p>
      </div>
      <div class="container">
        <ul class="list-group">
            <li class="list-group-item" aria-current="true">Text One</li>
            <li class="list-group-item">Text Two</li>
            <li class="list-group-item">Text Three</li>
            <li class="list-group-item">Text Four</li>
        </ul>
      </div>
    ...
    <div class="position-relative overflow-hidden  text-center ">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <button  style="background-color:#2260a7;" type="submit" name="submit" class="btn btn-success">ارسال العلومات</button>
        </form>
      </div>
    </div>
    ...
    <div class="d-grid gap-2 col-6 mx-auto my-5">
      <button style="background-color:#2260a7;" id="winner" type="button" class="btn btn-success" >
        اختار الرابح
      </button>
    </div>
